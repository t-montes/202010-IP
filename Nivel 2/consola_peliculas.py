...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    duracion = mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5)
    print(f"La duración promedio de las películas es: {duracion}")
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    a_estreno = int(input("Digite el año de estreno:\n"))
   
    estrenos = mod.encontrar_estrenos(p1, p2, p3, p4, p5, a_estreno)
    print(f"Las películas en estreno desde el año {a_estreno} son {estrenos}")
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    num_peliculas = mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)        
    print(f"Hay {num_peliculas} películas de categoría 18+")
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    # TODO: Completar
        ...
        nuevo_dia = input("Digite el día a reagendar la película:\n")
        nueva_hora = int(input("Digite la hora a reagendar la película:\n")) 
        control_horario = bool(input("Si desea aplicar el control de horario digite cualquier valor, de lo contrario, pulse enter.\n"))
    
        if(mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)):
            print(f"La película {nombre} se reagendó con éxito para el día {nuevo_dia} a las {nueva_hora//100}:{nueva_hora%100} horas.")
        else:
            print(f"La película {nombre} NO se pudo reagendar para el día {nuevo_dia} a las {nueva_hora//100}:{nueva_hora%100} horas.")
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
   ...
   # TODO: Completar
        ...
        edad_i = int(input("Digite la edad de la persona invitada: \n"))
        autorizacion = bool(input("Si el invitado tiene autorizacion de los padres digite cualquier valor, de lo contrario, pulse enter.\n"))
    
        if(mod.decidir_invitar(pelicula, edad_i, autorizacion)):
            print("¡Sí se puede invitar al usuario!")
        else:
            print("Lo sentimos, no puedes invitar al usuario.")
